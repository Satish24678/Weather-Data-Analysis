...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://weather-data-01/date={current_date}/weather_api_data.csv"], #dynamic data assignment
        "recurse": True, # cram up every thing inside the folder, sub-folder
    },
...
# ingesting above schema into redshift

redshift_output = glueContext.write_dynamic_frame.from_options(
    frame=changeschema_weather_dyf,
    connection_type="redshift",
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assets-767397830974-us-east-1/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::767397830974:role/service-role/AmazonRedshift-CommandsAccessRole-20240729T222621",
